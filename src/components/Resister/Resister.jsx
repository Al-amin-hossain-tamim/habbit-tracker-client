...
const Resister = () => {
  ...
  const [error,setError] = useState('');
    ...
    const handleRegister = (e)=>{
        ...
        const passwordValidation = /^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?]).{6,}$/;
        ...
        if(!emailValidation.test(email)){
          ...
          return setError('please ensure one upper,lower case and one digit and special character and at least 6 characters')
        }
    ...
    return (
        <div className="card bg-base-100 w-full mx-auto my-15 max-w-sm shrink-0 shadow-2xl">
          ...
          <div className="card-body">
            ...
            <h5>Already you have account?Please, <Link to='/Login' className="text-blue-600 underline text-[16px] font-medium">Login</Link></h5>
          </div>
        </div>
